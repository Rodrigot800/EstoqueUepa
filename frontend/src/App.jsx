...
function BatchModal({kind, warehouse, products, onClose, onSaved}) {
  ...
  const empty = isProduct ? {name:'',unit:'UN',minimum:0} : {productId:'',type:'',quantity:''};
